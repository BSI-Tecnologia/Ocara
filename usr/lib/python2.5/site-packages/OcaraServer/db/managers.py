...
class OpenDebtsOtherManager(BaseFlow):
    ...
    def get_debts_by_user(self, user_id):
        s = select([OpenDebtOtherItem.id_description, OpenDebtOtherItem.day, OpenDebtOtherItem.month, OpenDebtOtherItem.year, OpenDebtOtherItem.start_time, OpenDebtOtherItem.end_time, OpenDebtOtherItem.value],

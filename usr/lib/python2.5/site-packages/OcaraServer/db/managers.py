...
from OcaraServer.db.models import OpenDebtMachineItem, OpenDebtOtherItem, OpenDebtMachineItemBck, Version, UserCategory, DescriptionOpenDebtsOther
...
#Classe responsￃﾡvel por Gerenciar(consultas em geral) a tabela OpenDebtsMachineBck.
class OpenDebtsMachineBckManager(BaseFlow):

    __table_name__ = "opendebts_machine_bck"

    def __init__(self, db_session):
        BaseFlow.__init__(self, db_session, OpenDebtMachineItemBck)
        ...
        self.mapper = mapper(OpenDebtMachineItemBck, self.table)



    def get_debts_by_user_date(self, from_date, to_date,  user_id):
        s = select([OpenDebtMachineItemBck.id, OpenDebtMachineItemBck.day, OpenDebtMachineItemBck.month, OpenDebtMachineItemBck.year, OpenDebtMachineItemBck.start_time, OpenDebtMachineItemBck.end_time, OpenDebtMachineItemBck.value],
              and_(OpenDebtMachineItemBck.user_id==user_id))

...
class OpenDebtMachineItemBck(object):
    __name__ = "OpenDebtMachineItemBck"

    #Método que "representa" o objeto, por exemplo ao usar o comando
    # "print objeto".
    def __repr__(self):
        return "<OpenDebtMachineItemBck(%0.2f)>" % self.value
...
class Perfil(object):
    ...
    perfil_description = None

    def __init__(self, perfil_description):
        self.perfil_description = perfil_description

    def __repr__(self):
        return "<Perfil(%s)>" % (self.perfil_description)

class Perfil_User(object):
    __name__ = "Perfil_User"

    user_id = None
    perfil_id = None

    def __init__(self, user_id, perfil_id):
        self.user_id = user_id
        self.perfil_id = perfil_id

    def __repr__(self):
        return "<Perfil_User(id_user: %s, id_perfil: %s)>" % (self.user_id, self.perfil_id)


class ActionCategory(object):
    __name__ = "ActionCategory"
    ...
    def __repr__(self):
        return "<ActionCategory(%s)>" % (self.description)
...
class Action(object):
    ...
    def __init__(self, action_category_id, description):
        self.action_category_id = action_category_id
        self.description = description

    def __repr__(self):
        return "<Action(action_category_id: %s, description: %s)>" % (self.action_category_id, self.description)


class PerfilAction(object):
    __name__ = 'PerfilAction'

    action_id = None
    perfil_id = None

    def __init__(self, action_id, perfil_id):
        self.action_id = action_id
        self.perfil_id = perfil_id

    def __repr__(self):
        return "<PerfilAction(action_id: %s, perfil_id: %s)>" % (self.action_id, self.perfil_id)

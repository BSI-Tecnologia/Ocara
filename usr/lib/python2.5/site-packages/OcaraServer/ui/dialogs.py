...
class relatorio_utilizacao_frequentador:
    ...
    def on_pesquisar_clicked(self, obj):
        ...
        result = self.manager.opendebts_machine_bck_manager.get_debts_by_user_date(str_inicio, str_fim, selected_user.id)
        result_open_debts = self.manager.open_debts_other_manager.get_debts_by_user(selected_user.id)
...
class relatorio_utilizacao_bens:
    ...
    def on_pesquisar_clicked(self, obj):
        ...
        for row in result:
            dt_ini = (row[0]).day
            dt_fim = (row[2]).day
            duracao_emprestimo = dt_fim - dt_ini if dt_fim - dt_ini >= 0 else 0

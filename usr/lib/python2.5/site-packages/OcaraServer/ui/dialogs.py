...
class consulta_movimento:
    ...
    def __init__(self, manager):
        ...
        self.manager = manager
	self.opendebtsList = self.manager.open_debts_other_manager.get_debts_by_date(2012,10,6)
    ...
    def run(self):
        ...
        for line in self.opendebtsList:
	    print line[0]
	    opendebtsotherValor =+ int(line.value) 
	
  	self.cashflowStore.append(None, [opendebtsotherValor, opendebtsotherValor])

...
class relatorio_utilizacao_frequentador:
    ...
    def on_pesquisar_clicked(self, obj):
        ...
        liststore_open_debts = gtk.ListStore(str, str)
        ...
        for item in result_open_debts:
            liststore_open_debts.append([ ("%s-%s-%s" % (item[0], item[1], item[2])), "R$: %.2f" % item[5]])
        ...
        open_debts_column2 = gtk.TreeViewColumn("Valor")

	...
	self.opendebtsStore.clear()
		...
		string_data = str(line[2]) + '/' + str(line[1]) + '/' + str(line[0])
		    ...
		    days.append(date_time)
            	    for cash in self.manager.cash_flow_manager.get_debts_by_date(int(line[0]), int(line[1]), int(line[2]), int(line[0]), int(line[1]), int(line[2])):
		...
		tempo_utilizado = fim - inicio
	    	...
	    	self.opendebtsStore.append(None, [ date_time, 'Outros', tempo_utilizado, line[5], cashflowValor, restCashValor])
		self.data = self.data + str(date_time) + '     Outros     ' + str(tempo_utilizado) + '    R$:' + str(line[5]) + ' -    R$:' + str(cashflowValor) + ' -   R$:' + str(restCashValor) + '\n\r'
		    ...
		    days.append(date_time)
            	    for cash in self.manager.cash_flow_manager.get_debts_by_date(int(line[0]), int(line[1]), int(line[2]), int(line[0]), int(line[1]), int(line[2])): #recupera o pagamento do dia
	            	cashflowValor += (cash[0] + restCashValor)
	    	elif cashflowValor < 0: #Testa se há saldo a devolver
	    	    cashflowValor = restCashValor * -1
		...
		tempo_utilizado = fim - inicio
	    	...
	    	restCashValor += int(line[5]) - int(cashflowValor)
	    	self.opendebtsStore.append(None, [ date_time, 'Internet', tempo_utilizado, 'R$:' + str(line[5]), 'R$:' + str(cashflowValor), 'R$:' + str(restCashValor)])
		self.data = self.data + str(date_time) + '     Internet     ' + str(tempo_utilizado) + '    R$:' + str(line[5]) + ' -    R$:' + str(cashflowValor) + ' -   R$:' + str(restCashValor) + '\n\r'

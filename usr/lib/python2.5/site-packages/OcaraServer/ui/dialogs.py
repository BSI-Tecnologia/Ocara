...
class lista_perfil:
    ...
    def run(self):
        ...
        for perfil in self.perfilList:
            labelUsuario = gtk.Label()
            labelUsuario.set_markup(str(perfil.id))
            labelUsuario.set_alignment(0, 0.5)
            table.attach(labelUsuario, 0, 1, linha_atual[0], linha_atual[1])
            labelUsuario.show()

            valorUsuario = gtk.Label()
            valorUsuario.set_markup(str(perfil.perfil_description))
            valorUsuario.set_alignment(0, 0.5)
            table.attach(valorUsuario, 1, 2, linha_atual[0], linha_atual[1])
            valorUsuario.show()	

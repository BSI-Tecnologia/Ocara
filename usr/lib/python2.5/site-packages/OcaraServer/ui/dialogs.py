...
class relatorio_utilizacao_frequentador:
    ...
    def on_pesquisar_clicked(self, obj):
        ...
        result_open_debts = self.manager.open_debts_machine_manager.get_debts_by_user(selected_user.id)
        ...
        for item in result_open_debts:
            liststore_open_debts.append([ ("%s-%s-%s" % (item[1], item[2], item[3])), "R$: %.2f" % item[6]])

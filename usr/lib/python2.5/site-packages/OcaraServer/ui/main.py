...
class Manager:
    ...
    def setup_btnRelatorios(self):
        ...
        callbacks = [self.on_consultar_movimento_clicked, self.on_consultar_movimento_clicked, self.on_utilizacao_bens_clicked, self.on_utilizacao_frequentador_clicked]
        items = [gtk.MenuItem(label=l) for l in labels]

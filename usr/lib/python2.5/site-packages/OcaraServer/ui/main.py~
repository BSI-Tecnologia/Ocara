...
class Manager:
	...
	os.system("sed -ri 's/^03 10 \* \* \* root sarg/\#03 10 \* \* \* root sarg/g' /etc/crontab")
        ...
        os.system("/etc/init.d/squid stop | zenity --progress --percentage=0 --text 'Aguarde enquanto sua solicitação está sendo atendida...' --title 'Processando solicitação' --auto-close")

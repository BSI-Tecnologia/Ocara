...
from OcaraServer.db.models import UserCategory, Heritage, Block
from OcaraServer.db.models import AlienationMachine, BlockBorrow, Address
from OcaraServer.db.models import Occupation, RegistroGeral, CertidaoNascimento
from OcaraServer.db.models import OpenDebtOtherItem, BlockBorrow, Telecentro, City
from OcaraServer.db.models import ReserveOfBorrow, ScheduleOfBorrow
...
class Manager:
	...
	###BSI
        ...
        ###BSI
        self.bntaction5 = self.xml.get_object('bntaction5')
        ###BSI
    ...
    ###BSI
    def on_bntaction5_clicked(self, obj):
        model, iteration = self.get_selects(self.seltree)
    ...
    ####BSI listaPerfis
    def on_bntaction6_clicked(self, obj):
        model
    ...
    def set_page_selected(self, num):
        ...
        if num == 0:
            ...
            self.bntaction4.set_sensitive(True)
            ###BSI
            self.bntaction5.show()
            self.bntaction5.set_sensitive(True)
            ###BSI
            ...
            self.bntaction5.set_label('Perfil usuário')
            self.bntaction5.set_stock_id(gtk.STOCK_DIALOG_AUTHENTICATION)
            ###BSI
